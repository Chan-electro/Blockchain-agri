  ...
  return (
    <section className="h-screen w-full">
      <div className="relative h-full w-full overflow-hidden rounded-2xl md:rounded-[2rem]">
        ...
        {/* Background video — swap src for an agriculture video of your choice */}
        <video
          autoPlay
          loop
          muted
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-2 sm:px-6 md:px-10">
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 lg:col-span-8">
              <h1
                className="font-medium leading-[0.85] tracking-[-0.07em] text-[18vw] sm:text-[16vw] md:text-[15vw] lg:text-[13vw] xl:text-[12vw] 2xl:text-[13vw]"
                style={{ color: "#E1E0CC" }}
              >
        ...
        <motion.p
          ...
          className="absolute bottom-4 left-4 text-[9px] sm:left-6 md:left-10 sm:text-[10px]"
